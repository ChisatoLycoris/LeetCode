 ...
 */
public class _0013_RomanToInteger implements HashTablePattern, MathPattern, StringPattern, Easy {
    public int practice(java.lang.String s) {
        int result = 0;
        int length = s.length();
    ...
    public int optimal(java.lang.String s) {
